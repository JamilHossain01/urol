class AllMapGymModel {
  ...
  final List<AllMapGymData>? data;

  factory AllMapGymModel.fromJson(Map<String, dynamic> json){
    return AllMapGymModel(
      success: json["success"],
      message: json["message"],
      data: json["data"] == null ? [] : List<AllMapGymData>.from(json["data"]!.map((x) => AllMapGymData.fromJson(x))),
    );
  }
...
class AllMapGymData {
  ...
  factory AllMapGymData.fromJson(Map<String, dynamic> json){
    return AllMapGymData(
      id: json["_id"],
