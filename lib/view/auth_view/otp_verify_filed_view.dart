...
import 'dart:async';
import 'package:calebshirthum/view/auth_view/controller/otp_submit_controller.dart';
...
class OTPVerifyView extends StatefulWidget {
  ...
  OTPVerifyView(
      {this.countryCode, this.localNumber, Key? key, required this.email})
      : super(key: key);
                  ...
                  children: [
                    ...
                    GestureDetector(
                      ...
                      child: CustomText(
                        ...
                        fontWeight: FontWeight.w500,
                        fontSize: 14.sp,
                        color: _canResend ? AppColors.mainColor : Colors.grey,
                        underlined: true,
                        underlineColor:
